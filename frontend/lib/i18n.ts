...
export const vi = {
  ...
  checkout: {
    ...
    codSubtitle: 'Thanh toán khi đơn hàng được giao đến bạn.',
    codBadge: 'Phổ biến',
    bankTransfer: 'Chuyển khoản ngân hàng',
    bankTransferSubtitle: 'Nhận mã tham chiếu và nội dung chuyển khoản sau khi đặt hàng.',
    bankTransferBadge: 'Xác nhận sau khi ngân hàng ghi nhận',
    simulatedCard: 'Thẻ ngân hàng / Thanh toán trực tuyến',
    simulatedCardCopy: 'Thanh toán an toàn qua cổng thanh toán.',
    simulatedCardBadge: 'Bảo mật bởi đối tác thanh toán',
    simulatedCardBrand: 'Thương hiệu thẻ',
    simulatedCardLastFour: 'Bốn số cuối',
    simulatedCardWarning: 'Môi trường thử nghiệm — không phát sinh tiền thật. Giao dịch đang được xử lý trong môi trường thử nghiệm.',
    orderSummary: 'Tóm tắt đơn hàng',
    placeOrder: 'Đặt hàng',
  ...
  payment: {
    ...
    bankTransfer: 'Chuyển khoản ngân hàng',
    simulated_card: 'Thẻ ngân hàng / Thanh toán trực tuyến',
    momo: 'Ví MoMo',
