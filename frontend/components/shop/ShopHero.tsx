...
const trustBadges = ['Người bán đã xác thực', 'Đã kiểm tra tình trạng', 'Giá niêm yết VNĐ', 'Thời trang địa phương'];
      ...
      <div className="relative z-20">
        <Container className="py-14 sm:py-20">
          ...
          <p className="mt-5 max-w-xl text-base leading-relaxed text-neutral-200 sm:text-lg">
            Khám phá thương hiệu địa phương, đồ đã qua sử dụng và các tin đăng streetwear từ người
            bán trên khắp Việt Nam.
          </p>
