    ...
    <section className="border-y border-neutral-800 bg-neutral-950 py-12 text-white sm:py-16">
      <Container>
        <div className="mb-7 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="font-mono text-[10px] uppercase tracking-[0.24em] text-neutral-400">MẶC BỀN HƠN · LAN TỎA GIÁ TRỊ</p>
            <h2 className="mt-2 max-w-2xl font-display text-3xl font-black uppercase leading-[1.08] tracking-tight sm:text-5xl">
              Minh bạch trong
              <br />
              từng sản phẩm.
            </h2>
