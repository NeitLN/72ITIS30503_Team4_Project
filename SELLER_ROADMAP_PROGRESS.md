...
| 4 | Inventory, Variants, and Listing Quality | Partial — listing-quality checklist widget only (client-side, cosmetic); no inventory logic, no variant schema/support, no oversell prevention; not re-scoped in this remediation | b530018 | No | No | (Done) | Phase 5 |
