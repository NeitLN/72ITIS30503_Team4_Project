...
| 4 | Inventory, Variants, and Listing Quality | Completed — implemented simple and variant inventory modes, full atomic checkout oversell prevention, deterministic quality score | b530018 + phase4-completion | No | No | (Done) | Phase 5 |
